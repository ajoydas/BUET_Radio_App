 ...
 */
public class FragmentDrawerNotification extends Fragment {
    ...
    public FragmentDrawerNotification() {
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerDrawer.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), mRecyclerDrawer, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                ((NotificationActivity) getActivity()).onDrawerItemClicked(position - 1);
            }
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close) {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                ...
                ((NotificationActivity) getActivity()).onDrawerSlide(slideOffset);
